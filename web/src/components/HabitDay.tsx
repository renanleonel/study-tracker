...
export function HabitDay({defaultCompleted = 0, amount = 0, date}: HabitDayProps){
    ...
    return (
        <Popover.Root>
            <Popover.Trigger className={clsx('w-10 h10 border-2 rounded-lg transition-colors focus:outline-none focus:ring-2 focus:ring-red-600 focus:ring-offset-2 focus:ring-offset-background', {
            ...
            <Popover.Portal>
                <Popover.Content className='min-w-[320px] p-6 rounded-2xl bg-zinc-900 flex flex-col'>
                    ...
                    <span className='mt-1 font-extrabold leading-tight text-3xl text-white'>{dayAndMonth}</span>
